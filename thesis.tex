...
%%-- Committee members
%% format: \thesisCommittee[Department]{First name Last name, Professional title}{Institutional affiliation}
%% tips: Individuals sometimes may have multiple affiliations, departments, and titles. -- Karim
%%       Additionally, names are easy to misspell and individuals may have preferred names. 
%%       Last-minute errors and having to do multiple rounds of signatures are no fun.
%%       Don't assume, go straight to the source.
%%       For WM committee members:
%%         1) get the information from https://directory.wm.edu/people/index.cfm. 
%%         2) ask them to confirm. 
%%       For external committee members:
%%         1) ask them to provide all the information directly. 
%% examples 
%%  \thesisCommittee[Department]{John Doe, Professor}{ABC College}
%%  \thesisCommittee{John Doe, Other title}{XYZ Company}
%%  \thesisCommittee[Copration Department]{John Doe, Other title}{XYZ Company}
...
\thesisCommittee[Applied Science]{Outside Committee Member Name, Title}{University of X}
%% for more details see: https://www.wm.edu/as/graduate/_forms/physicalstandardsforms/approval-page.docx
